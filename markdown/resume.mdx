...
Over 10 years building scalable analytics applications, I led major
migrations and integrations that enhanced user experience and developer efficiency. At
ThoughtSpot, I integrated Mode into Analyst Studio and architected a Slack-based visual
regression tool that reduced deployment overhead. At Mode I optimized data flows and real
user monitoring to boost visualization performance. I mentor cross-functional teams, drive
Agile adoption, and champion code quality to deliver reliable, high-performance user interfaces.
